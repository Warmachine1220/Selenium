...
public class Nonindi_onboard {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.get("https://sbcdev.crmnext.com/crlive/app/login/login"); // url
...
//dedupe handled
		...
		if (driver.findElements(By.className("button-group__item")).size() > 2) {
			driver.switchTo().activeElement();
...
//clicking on process appliacation
		...
		System.out.printf(
				"lead id = "
						+ driver.findElement(By.xpath("//*[@id=\"objectWrapper\"]/div/div[3]/div[1]/div/div/div/span"))
								.getText()
						+ "\n Status code: %s \n This lead is on please Hit this lead id on soap to to account open",
				(driver.findElement(By.xpath("//span[@data-autoid = 'LE_STATUSCODE_ctrl']")).getText()));

...
public class dedupe {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String For_Employment = "No";
		String TIN = "443344343";
		...
		driver.get("https://sbcdev.crmnext.biz/sn/app/login/login"); // url
		...
		suffix1.selectByVisibleText(suffix);
		...
		mm.selectByValue(splittedStrings[0]);
		...
		dd.selectByValue(splittedStrings[1]);
		...
		// WebElement ded = driver.switchTo().activeElement();//
		// .findElement(By.className("ui-dialog-titlebar")).getText()
		// ded.findElement(By.className("ui-dialog-titlebar")).getText().equalsIgnoreCase("Duplicate
		// Record Listing");
		// System.out.println(ded);
		// if (ded == true) {
		// driver.switchTo().activeElement().findElement(By.className("button-group__item")).click();
		// }
		// Lead created
		...
		// Select business_Segment = new
		// Select(driver.findElement(By.name("cust_2592"))); //Segment type autofilling
		// right now
